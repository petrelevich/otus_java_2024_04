...
public class ActionDemo implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        var managerSecond = dbServiceManager.saveManager(new Manager(
                ...
                "ManagerSecond",
                Set.of(
                        new Client("managClient1", managerName, 11, new ClientDetails(null, "inf01")),
                        new Client("managClient2", managerName, 22, new ClientDetails(null, "info2"))),
                List.of(
                        new Client("managClient1Ordered", managerName, 100, new ClientDetails(null, "inf01")),
                        new Client("managClient2Ordered", managerName, 200, new ClientDetails(null, "info2"))),
                true));
